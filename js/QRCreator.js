(()=>{
    ...
    const t = {
        ...
        ,
        ALPHANUMERIC_MAP: "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ $%*+-./:".split("").reduce(((t,e,s)=>(t[e] = s,
        t)), {}),
        GF256: [],
        GF256_INV: [-1],
        GF256_GENPOLY: {},
    ...
    for (let e = 0, s = []; e < 30; ++e) {
        ...
        s = r,
        [7, 10, 13, 15, 16, 17, 18, 20, 22, 24, 26, 28, 30].includes(e + 1) && (t.GF256_GENPOLY[e + 1] = r)
    }
    ...
    class s {
        ...
        set image(e) {
            ...
            t.IMAGE.includes(e) || (this.error = "image",
            this.errorSubcode = "3"),
            this.error || (()=>{
                ({
                    NONE: ()=>{
                    ...
                    PNG: ()=>{
                        ...
                        let n;
                        if (o.width = o.height = i,
                        n = o.getContext("2d"),
                        !n)
                            return this.error = "image",
                            void (this.errorSubcode = "2");
                        n.fillStyle = "#fff",
                        n.fillRect(0, 0, i, i),
                        n.fillStyle = "#000";
                        for (let i = 0; i < e; ++i)
                    ...
                    HTML: ()=>{
                        ...
                        for (let t = 0; t < s; ++t) {
                            i.push("<tr>");
                            for (let o = 0; o < s; ++o)
                                i.push('<td style="width:' + r + "px; height:" + r + "px" + (e[t][o] ? ";background:#000" : "") + '"></td>');
                            i.push("</tr>")
                        }
                        t.className = "qrcode",
        ...
        download(t="", e=this.image) {
            ...
            this.result) {
                ...
                case "PNG":
                    t || (t = "qrcode.png"),
                    s = this.result.toDataURL();
                    break;
                case "SVG":
                    t || (t = "qrcode.svg"),
                    s = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="${this.result.getAttribute("viewBox")} ">${this.result.innerHTML}</svg>`,
    ...
    class r {
        ...
        set version(e) {
            const s = this.mode
              , r = this.eccl;
            this._version = e,
            t.isMode(s) && t.isEccl(r) && e > 0 && e < 41 && this.fixedInfoVersion(e, s, r)
        }
        get version() {
        ...
        dataToCodewords() {
            ...
            ;
            switch (a(r, 4),
            a(s, this.bitsFieldDataQty),
            r) {
            case t.MODE_NUMERIC:
                for (let t = 2; t < s; t += 3)
                    a(+(e[t - 2] + e[t - 1] + e[t]), 10);
                const r = [0, 4, 7][s % 3];
            ...
            case t.MODE_ALPHANUMERIC:
                ...
                for (let t = 1; t < s; t += 2)
                    a(45 * i[e[t - 1]] + i[e[t]], 11);
                s % 2 && a(i[e[s - 1]], 6);
                break;
            case t.MODE_OCTET:
                e.forEach((t=>a(t, 8)))
            }
            for ((o.length < i - 1 || 8 === l) && a(t.MODE_TERMINATOR, 4),
            l < 8 && o.push(n); o.length + 1 < i; )
                o.push(236, 17);
        ...
        makeCodewordsQR() {
            const e = this.qtyBlocks
              ...
              , l = [];
            for (let t = 0; t < e; ++t)
                l.push(o(s.slice(n.pos[t], n.pos[t + 1]), r));
        ...
        makeMatrix() {
            ...
            const a = this.codewordsQR
              ...
              , f = t=>{
                ...
                for (let r = 0; r < 15; ++r)
                    c[8][s[r]] = c[e[r]][8] = t >> r & 1
            }
            ;
            for (let t = 0; t < h; ++t)
                c[t] = new Array(h).fill(null),
                s && (d[t] = new Array(h).fill(null));
            ...
            if (s) {
                const e = e=>{
                  ...
                  , s = Array(t.MASKFUNCS.length).fill(0).map(((t,s)=>(s && e(s),
                this.maskTest(c))));
                r = s.reduce(((t,e,s)=>(e < t.score && (t.mask = s,
                t.score = e),
                t)), {
                    mask: 0,
                    score: s[0]
        ...
        maskTest(e) {
            ...
            const n = e=>{
                ...
                for (let r = 5; r < e.length; r += 2)
                    1 === e[r] && 1 === e[r - 1] && 3 === e[r - 2] && 1 === e[r - 3] && 1 === e[r - 4] && (e[r - 5] >= 4 || e[r + 1] >= 4) && (s += t.PENALTY.FINDERLIKE);
                return s
            }
            ;
            for (let l = 0; l < s; ++l) {
                ...
                for (let e = 1; e < s; ++e)
                    i += a[e],
                    a[e] === a[e - 1] && a[e] === h[e] && a[e] === h[e - 1] && (o += t.PENALTY.TWOBYTWO)
            }
            return o += t.PENALTY.DENSITY * ((Math.abs(100 * i / s / s - 50) - 1) / 5 | 0),
            o
        }
        report() {
    ...
    const i = e=>{
        ...
        try {
                ...
                try {
                    ...
                    if (r !== t.MODE_NUMERIC && -1 !== r || i.replace(o, ""))
                        if (r !== t.MODE_ALPHANUMERIC && -1 !== r || i.replace(n, "")) {
                            if (r !== t.MODE_OCTET && -1 !== r)
                                throw s("mode", "1");
                            r = t.MODE_OCTET
                        } else
                            r = t.MODE_ALPHANUMERIC;
                    else
                        r = t.MODE_NUMERIC
                } catch (t) {
                    if ("QRoptionsError" === t.name)
            ...
            -1 !== e.mask && (e.mask < 0 || e.mask > 8 || r(e.mask)))
                throw s("mask", "1");
            if (!t.IMAGE.includes(e.image))
                throw s("image", "1");
            if (-1 === e.modsize)
                e.modsize = t.modsize;
            else if (e.modsize < 1 || r(e.modsize))
                throw s("modsize", "1");
            if (-1 === e.margin)
                e.margin = t.margin;
            else if (e.margin < 0 || r(e.margin))
                throw s("margin", "1")
        } catch (t) {
            e.error = t.setting,
            e.errorSubcode = t.subcode
        }
    }
    ;
